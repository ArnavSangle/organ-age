...
Figure~\ref{fig:pipeline} outlines the Organ-Age pipeline. The core idea is that
...
As a first multimodal baseline, I built a na\"ive fusion model that concatenates
...
\end{subfigure}
\caption{
\textbf{Hero subject: individualized organ-age profile for GTEX-1117F.}
...
The per-subject panels and attribution summaries extend the framework beyond prediction:
